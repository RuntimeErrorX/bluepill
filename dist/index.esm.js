...
var PanelFooter = function (_a) {
    ...
    return (React.createElement(Container$4, null,
        ...
        React.createElement(SocialEntry, null,
            cakePrice2Usd ? (React.createElement(PriceLink, { href: priceLink2, target: "_blank" },
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, priceLink = _a.priceLink, priceLink2 = _a.priceLink2, profile = _a.profile, children = _a.children;
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, priceLink: priceLink, priceLink2: priceLink2 }),
